...
from typing import Callable, Generator, List, Mapping, Optional, Sequence, Tuple, Union

import torch


# =============================================================================
# Streaming Types for Real-time Audio Generation
# =============================================================================
...
@dataclass(frozen=True)
class ErrorEvent:
    """Error event during generation."""
    error: str


# Union type for all stream events
StreamEvent = Union[AudioChunkEvent, StatusEvent, CompleteEvent, ErrorEvent]
StreamGenerator = Generator[StreamEvent, None, None]
